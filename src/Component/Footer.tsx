    ...
    return (
        <footer>
            <div className="top-footer">
                <div className="container">
                    <div className="top-footer-content">
                        <a href="/" className="logo-footer p-15-0" title="Thể thao 247">
            ...
            <div className="menu-footer">
                <div className="container">
                    <div className="menu-footer-content">
                        <div className="left">
                            <div className="list_bot_cat">
                                <p className="title_ver_com ">Tiện ích bóng đá</p>
                                <ul>
                            ...
                            <div className="list_bot_cat">
                                <p className="title_ver_com ">Giải đấu nổi bật</p>
                                <ul>
                            ...
                            <div className="list_bot_cat">
                                <p className="title_ver_com ">Bảng xếp hạng bóng đá</p>
                                <ul>
                        ...
                        <div className="right">
                            <div className="list_bot_cat">
                                <p className="title_ver_com ">Kết quả bóng đá</p>
                                <ul>
                            ...
                            <div className="list_bot_cat">
                                <p className="title_ver_com ">Thể thao tổng hợp</p>
                                <ul>
            ...
            <div className="tag-footer">
                <div className="container">
                    <div className="pkg">
                        <a href="/the-thao-24h.html" className="key_footer_tag" target="_blank" rel="noopener" title="Thể Thao 24h">Thể Thao 24h</a>
                        <a className="key_footer_tag" target="_blank" href="https://www.techz.vn/" rel="noopener" title="Techz.vn">Công nghệ</a>
                    </div>
                </div>
            </div>
            <div className="info-footer">
                <div className="container">
                    <div className="info-footer-content">
                        <div className="col_app_com">
                            <p className="title_ver_com ">App Mobile</p>
                            <ul className="list_ver_com" id="dowload_footer">
                                <li>
                                    <a href="https://apps.apple.com/app/id1485962204" target="_blank"
                                       rel="nofollow noopener" className="icon_appstore">
                                        <i className="fab fa-apple"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://play.google.com/store/apps/details?id=vn.thethao247.android&hl=vi"
                                       target="_blank" rel="nofollow noopener" className="icon_appstore icon_android">
                                        <i className="fab fa-android"></i>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        <div className="col_ver_com">
                            <p className="title_ver_com ">Liên hệ</p>
                            <ul className="list_ver_com">
                                <li><a href="/gioi-thieu-p1.html">Giới thiệu</a></li>
                                <li><a href="/chinh-sach-bao-mat-p5.html">Chính sách bảo mật</a></li>
                                <li><a href="/bao-gia.html" rel="nofollow">Quảng cáo</a></li>
                            </ul>
                        </div>
                        <div className="col_ver_com">
                            <p className="title_ver_com ">Social</p>
                            <ul className="list_ver_com">
                                <li>
                        ...
                        <div className="col_info_com">
                            <p className="title_ver_com "><strong>CÔNG TY CP DỊCH VỤ TRUYỀN THÔNG THỂ THAO 247</strong></p>
                            ...
                            <p style={{color:"darkgray"}}><strong>Trụ sở chính:</strong> Tầng 4, Tòa tháp Ngôi Sao - Star Tower,
                                đường Dương Đình Nghệ - Phường Yên Hòa - Quận Cầu Giấy - Hà Nội</p>
                            <a href="https://www.dmca.com/Protection/Status.aspx?ID=d31a2a19-f919-485f-93b2-8697b3a6ff75&amp;refurl=https://thethao247.vn/"
                               target="_blank" rel="nofollow noopener" title="DMCA.com Protection Status" className="dmca-badge">
                                <img
                                style={{marginLeft: -5}}
