                            ...
                            <ul className={"nav-content"}>
                                            ...
                                            <nav>
                                                ...
                                                <a href="https://thethao247.vn/quan-vot-tennis-c4/"
                                                   title="Tennis - Quần vợt">
                                                    Tennis - Quần vợt </a>
                                                <ul className={"more-sub-cate"}>
                                                    <li>
                                                        <a href="#">Xem thêm <i className="fa fa-angle-down"
                                ...
                                <li>
                                    ...
                                    <div className={"cate-child-2"}>
                                        <div className={"container"}>
                                            <nav>
                                                <a className="relative " href="https://thethao247.vn/esports-c180/"
                                                   title="Esports">
                                                    Esports
                                                </a>
